...
public class ExchangeClient {
  ...
  public static class ExchangeClientBuilder {
    ...
    public ExchangeClientBuilder() {
      ...
      this.password = "";
      this.subject = "";
      this.recipientTo = new ArrayList<>(3);;
     ...
     *
     * @param domain the domain of the Active Directory. The first part of the username. For
     *     example: MYDOMAIN\\username, set the MYDOMAIN.
     * @return the builder for chain usage.
     */
     ...
     *
     * @param recipientBcc the list with email addresses that will be used as bcc for this email
     *     send.
     * @return the builder for chain usage.
     */
  ...
  public boolean sendExchange() {
    ...
    try {
      ...
      exchangeService.setTimeout(1*60*1000);
    ...
    try {
      ...
      log.error("An exception occured while sstting the TO recipient(" + recipientTo + ").", ex);
      return false;
    }
